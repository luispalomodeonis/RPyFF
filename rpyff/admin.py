...
#   fields = ['dicho', 'explicacion', ('palabra', 'fecha'), ('letra', 'origen')]
   fieldsets = (
      ...
      ('Detalle', {'fields': (('palabra','fecha') ,('letra','origen'),('otraspalabras'),('fechaaprobacion','fechapublicacion'))}),
   )

admin.site.register(Refran,RefranAdmin)

#------------------------------------------------------
#  Clases para Proverbio
#------------------------------------------------------
class ProverbioAdmin(admin.ModelAdmin):
   list_display = ('dicho', 'estado', 'fecha', 'creador')
#   list_filter = ('estado', 'fecha')
   list_filter = ('estado', 'fecha', 'estado', 'origen')
#   fields = ('estado', 'palabra', 'fecha')
...
admin.site.register(Proverbio,ProverbioAdmin)
#------------------------------------------------------
#  Clases para Frase
#------------------------------------------------------
